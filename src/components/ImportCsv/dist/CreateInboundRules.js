...
var parseNestedObject = function (obj) {
    var result = {};
    Object.keys(obj).forEach(function (key) {
        if (key.includes('.')) {
            var keys_1 = key.split('.');
            keys_1.reduce(function (acc, part, index) {
...
function CreateInboundRules(_a) {
    var _this = this;
        ...
        return __generator(this, function (_a) {
            ...
            papaparse_1["default"].parse(file, {
                ...
                complete: function (results) { return __awaiter(_this, void 0, void 0, function () {
                    var data, _i, _a, row, siteName, serverGroupName, webServiceName, gatewayGroupName, aliasName, gatewayPort, body, url, parsedBody, response, error_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                row = _a[_i];
                                siteName = row.siteName, serverGroupName = row.serverGroupName, webServiceName = row.webServiceName, gatewayGroupName = row.gatewayGroupName, aliasName = row.aliasName, gatewayPort = row.gatewayPort, body = __rest(row, ["siteName", "serverGroupName", "webServiceName", "gatewayGroupName", "aliasName", "gatewayPort"]);
                                ...
                                url = "/api/createInboundRules?siteName=" + encodeURIComponent(siteName) + "&serverGroupName=" + encodeURIComponent(serverGroupName) + "&webServiceName=" + encodeURIComponent(webServiceName) + "&gatewayGroupName=" + encodeURIComponent(gatewayGroupName) + "&aliasName=" + encodeURIComponent(aliasName) + "&gatewayPort=" + encodeURIComponent(gatewayPort);
                                parsedBody = parseNestedObject(body);
                                _b.label = 2;
                            case 2:
                                _b.trys.push([2, 4, , 5]);
...
exports["default"] = CreateInboundRules;
