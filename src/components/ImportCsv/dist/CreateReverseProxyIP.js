...
function CreateReverseProxyIP(_a) {
    var _this = this;
        ...
        return __generator(this, function (_a) {
            ...
            papaparse_1["default"].parse(file, {
                ...
                complete: function (results) { return __awaiter(_this, void 0, void 0, function () {
                    var data, _i, _a, row, gatewayName, ip, body, url, response, error_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                row = _a[_i];
                                gatewayName = row.gatewayName, ip = row.ip, body = __rest(row, ["gatewayName", "ip"]);
                                // Debugging: Check extracted values
                                console.log('Extracted gatewayName:', gatewayName);
                                console.log('Extracted ip:', ip);
                                if (!gatewayName || !ip) {
                                    setError('CSV row missing gatewayName or ip');
                                    return [2 /*return*/];
                                }
                                url = "/api/createReverseProxyIP?gatewayName=" + encodeURIComponent(gatewayName) + "&ip=" + encodeURIComponent(ip);
                                _b.label = 2;
                            case 2:
                                _b.trys.push([2, 4, , 5]);
...
exports["default"] = CreateReverseProxyIP;
