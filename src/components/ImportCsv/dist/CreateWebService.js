        ...
        return __generator(this, function (_a) {
            ...
            papaparse_1["default"].parse(file, {
                ...
                complete: function (results) { return __awaiter(_this, void 0, void 0, function () {
                    var data, _i, _a, row, siteName, serverGroupName, webServiceName, body, key, url, response, error_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                row = _a[_i];
                                siteName = row.siteName, serverGroupName = row.serverGroupName, webServiceName = row.webServiceName, body = __rest(row, ["siteName", "serverGroupName", "webServiceName"]);
                                ...
                                for (key in body) {
                                    if (body.hasOwnProperty(key)) {
                                        ...
                                        body[key] = body[key].map(function (value) {
                                            if (value === "")
                                                return null;
                                ...
                                url = "/api/createWebService?siteName=" + encodeURIComponent(siteName) + "&serverGroupName=" + encodeURIComponent(serverGroupName) + "&webServiceName=" + encodeURIComponent(webServiceName);
                                _b.label = 2;
                            case 2:
                                _b.trys.push([2, 4, , 5]);
...
exports["default"] = CreateWebService;
