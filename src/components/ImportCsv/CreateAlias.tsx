...
export default function CreateAlias({ buttonText }: ImportCsvModalProps) {
    ...
    Papa.parse(file, {
      ...
      complete: async (results) => {
        ...
        for (const row of data as any[]) {
          const { gatewayName, aliasName, ...body } = row;
          ...
          const url = `/api/createAlias?gatewayName=${encodeURIComponent(gatewayName)}&aliasName=${encodeURIComponent(aliasName)}`;
