...
export default function CreateReverseProxyIP({ buttonText }: ImportCsvModalProps) {
    ...
    Papa.parse(file, {
      ...
      complete: async (results) => {
        ...
        for (const row of data as any[]) {
          ...
          const url = `/api/createReverseProxyIP?gatewayName=${encodeURIComponent(gatewayName)}&ip=${encodeURIComponent(ip)}`;
